...
how to use Notears algorithm in `castle` package for causal inference.
...
df = pd.read_csv("data_hepar2.csv")
true_dag = np.load('truth_hepar2.npy') # ground-truth, should be a numpy array
